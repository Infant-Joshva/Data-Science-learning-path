...
user_input = {
    'Age': Age, 'Education': Education, 'EnvironmentSatisfaction': EnvironmentSatisfaction,
    ...
    'TotalWorkingYears': TotalWorkingYears, 'WorkLifeBalance': WorkLifeBalance,
    'YearsAtCompany': YearsAtCompany, 'YearsSinceLastPromotion': YearsSinceLastPromotion,
    'YearsWithCurrManager': YearsWithCurrManager, 'Department': Department, 'Gender': Gender,
